...
To build it, upload the [E-Z UART printed circuit board (PCB) Gerber files](https://github.com/shabaz123/e_z_uart/raw/refs/heads/main/export-gerbers-ez-uart-rev1.zip) to any PCB manufacturer website.
